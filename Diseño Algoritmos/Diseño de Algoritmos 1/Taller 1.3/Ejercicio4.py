...
Opciones: 
- Candidato Taller 1 - Sets.2 → Partido rojo
...
def votar(candidato: str) -> str:
    ...
    ----------
    candidato : str
        Letra del candidato elegido (Taller 1 - Sets.2, B, C o D)
...
candidato = input("Ingrese la letra del candidato por el que desea votar (Taller 1 - Sets.2(Partido rojo), B(Partido verde), C(Partido azul), D(Voto en Blanco)): \n")
